        ...
        <Flex vertical gap={32}>
          <div className="animate-fade-in">
            ...
            <Text style={{ color: "var(--text-dim)" }}>
              Welcome back to your Task Pilot control center.
            </Text>
          </div>
          ...
          <Row gutter={[24, 24]} className="animate-slide-up">
            ...
            <Col xs={24} sm={8}>
              <Card className="glass-card" variant="borderless">
                <Statistic
                  title={
                    <Text style={{ color: "var(--text-dim)" }}>Completed</Text>
                  }
                  value={48}
            ...
            <Col xs={24} sm={8}>
              <Card className="glass-card" variant="borderless">
                <Statistic
                  title={
                    <Text style={{ color: "var(--text-dim)" }}>Pending</Text>
                  }
                  value={4}
          ...
          >
            ...
            >
              <Text style={{ color: "var(--text-dim)" }}>
                Detailed analytics and task list coming soon...
              </Text>
            </Flex>
          </Card>
        </Flex>
